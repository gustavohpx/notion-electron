...
export function Sidebar() {
  ...
  return (
    <aside className="bg-notion-800 flex-shrink-0 border-r border-notion-600 h-screen relative group data-[state=open]:animate-slideIn data-[state=closed]:animate-slideOut overflow-hidden">
      <button
        className={clsx(
